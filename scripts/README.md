...
- `demo.ps1` — end-to-end runner: starts `demo-api`, hammers endpoints to produce Elastic logs, launches `HotFixAmbulance.Api` + `frontend`, invokes the CLI, captures screenshots.
